...
const Layout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/kesilmis-urun', label: 'Kesilmiş Ürün', icon: Package },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="bg-gray-950 border-gray-800" data-testid="stat-normal-stock">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-gray-400">Normal Stok (Adet)</CardTitle>
            <Warehouse className="h-4 w-4 text-green-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">{stats.normalStock}</div>
          </CardContent>
        </Card>

        <Card className="bg-gray-950 border-gray-800" data-testid="stat-cut-stock">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-gray-400">Kesilmiş Stok (Adet)</CardTitle>
            <Warehouse className="h-4 w-4 text-orange-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">{stats.cutStock}</div>
          </CardContent>
        </Card>
      </div>
